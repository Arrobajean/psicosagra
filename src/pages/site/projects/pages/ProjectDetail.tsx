...
const ProjectDetail = () => {
  ...
  const pageTitle = `${project.title} | Trabajo de reforma en Madrid | Psicosagra`;
  const pageDescription =
    project.description ||
    "Trabajo de reforma integral realizado por Psicosagra en Madrid.";
  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`https://psicosagra.es/nuestros-trabajos/${project.slug}`}
        />
        <meta property="og:image" content={project.image} />
        <link
          rel="canonical"
          href={`https://psicosagra.es/nuestros-trabajos/${project.slug}`}
        />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "image": "${project.image}",
            "url": "https://psicosagra.es/nuestros-trabajos/${project.slug}",
            "brand": {
              "@type": "Organization",
              "name": "Psicosagra"
            },
